...
**Step 2 — append the competitor row as plain values.** No per-row formatting neede, basically just add one new row containing this competitor's 13 values to the bottom of the sheet.
```
