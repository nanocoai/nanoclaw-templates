...
When the scope contains agent skills, plugins, MCP servers or clients, or agent
instruction files, verify each artifact against the standard that governs it:
...
Follow the [shared expert protocol](expert-protocol.md).
