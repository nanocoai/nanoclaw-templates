...
schedule: "0 */6 * * *"
script: |
  if ls /workspace/agent/plugin-data/rese/pending/*.json >/dev/null 2>&1; then
    echo '{"wakeAgent": true}'
  else
